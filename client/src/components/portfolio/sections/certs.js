...
const data = [
    <img className={Styles.images} src={frontEndCert} alt='1'/>,
    <img className={Styles.images} src={backEndCert} alt='2'/>,
    <img className={Styles.images} src={javaScriptCert} alt='3'/>,
    <img className={Styles.images} src={responsiveWebCert} alt='4'/>,
]
        ...
        <div className="section" style={{backgroundColor: '#30475E'}}>
            <motion.div className={Styles.sectionBlackContent} initial={{opacity: 0}} whileInView={{opacity: 1, transition: {delay: 0.25, duration: 1}}} viewport={{once: true}}>
                ...
                <Carousel className={Styles.images} cellAlign='center' framePadding='30px' >
                    ...
                    <img className={Styles.image} src={backEndCert} alt='2'/>
            ...
            <div className={Styles.dividerCertsSVG}>
                <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
                    ...
                    <path d="M0,0V15.81C13,36.92,27.64,56.86,47.69,72.05,99.41,111.27,165,111,224.58,91.58c31.15-10.15,60.09-26.07,89.67-39.8,40.92-19,84.73-46,130.83-49.67,36.26-2.85,70.9,9.42,98.6,31.56,31.77,25.39,62.32,62,103.63,73,40.44,10.79,81.35-6.69,119.13-24.28s75.16-39,116.92-43.05c59.73-5.85,113.28,22.88,168.9,38.84,30.2,8.66,59,6.17,87.09-7.5,22.43-10.89,48-26.93,60.65-49.24V0Z" opacity=".5" className={Styles.certsDivider}></path>
                    <path d="M0,0V5.63C149.93,59,314.09,71.32,475.83,42.57c43-7.64,84.23-20.12,127.61-26.46,59-8.63,112.48,12.24,165.56,35.4C827.93,77.22,886,95.24,951.2,90c86.53-7,172.46-45.71,248.8-84.81V0Z" className={Styles.certsDivider}></path>
                </svg>
            </div>
        </div>
    )
